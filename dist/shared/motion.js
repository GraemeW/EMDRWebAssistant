...
exports.RAMP_DURATION = exports.TIME_OFFSET_FACTOR = exports.MAX_FRACTIONAL_SPEED = exports.MIN_FRACTIONAL_SPEED = void 0;
exports.clamp01 = clamp01;
exports.speedToFractionPerSecond = speedToFractionPerSecond;
exports.getBounds = getBounds;
exports.computeAt = computeAt;
exports.MIN_FRACTIONAL_SPEED = 0.005;
exports.MAX_FRACTIONAL_SPEED = 0.05;
exports.TIME_OFFSET_FACTOR = 50.0;
/** Seconds to ramp fully between 0 and target speed on play/pause — matches BobbleMover.cs's _speedRampTime. */
exports.RAMP_DURATION = 1.5;
function clamp01(v) {
    return Math.min(1, Math.max(0, v));
}
function speedToFractionPerSecond(relativeSpeed) {
    const f = exports.MIN_FRACTIONAL_SPEED + (exports.MAX_FRACTIONAL_SPEED - exports.MIN_FRACTIONAL_SPEED) * relativeSpeed;
    return f * exports.TIME_OFFSET_FACTOR;
}
...
function computeAt(s, now) {
    ...
    const rampRate = fullSpeed / exports.RAMP_DURATION; // magnitude
    let distance;
    let speedNow;
